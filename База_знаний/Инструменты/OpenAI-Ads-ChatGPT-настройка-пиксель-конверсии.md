...
**Исключение — установка через GTM (раздел "Установка через Google Tag
Manager", Вариант А):** пройдена и подтверждена на практике 2026-08-11 в
реальном контейнере клиента, оба тега (инициализация + `Lead created`)
сработали корректно в Preview.
