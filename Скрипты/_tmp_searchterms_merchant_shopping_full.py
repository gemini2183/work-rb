#!/usr/bin/env python
# coding: utf-8
"""РАЗОВЫЙ скрипт: search_term_view для Merchant_Shopping, 2026-07-09..2026-09-07,
С РАЗБИВКОЙ ПО ДНЯМ - для сравнения недельного тренда search terms с трендом
по товарным категориям (найдено выше)."""
import pandas as pd
...
out_path = "../Клиенты/Корогва/Статистика/_tmp_searchterms_merchant_shopping_daily_2026-07-09_to_2026-09-07.csv"
